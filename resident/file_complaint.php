...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$category || !$details) {
        $error = 'Please select a category and describe the complaint.';
    } else {
        $rid = $acc['resident_id'];
        ...
        db_execute('INSERT INTO records (record_id, record_type, category, details, resident_id)
                    VALUES (?,?,?,?,?)',
                   [$record_id, 'complaint', $category, $details, $rid]);
        $submitted = $record_id;
    }
}
...
<div class="main-content">
  <div class="topbar">
    <div>
      <h5><i class="bi bi-exclamation-triangle me-2"></i>File a Complaint</h5>
      <small>Report barangay concerns</small>
    </div>
  </div>
  <div class="p-4">
    ...
    <div class="card">
      <div class="card-body text-center p-5">
        <div class="rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center"
          ...
          <i class="bi bi-check-circle-fill" style="font-size:2.5rem;color:#E53935;"></i>
        </div>
        <h4 class="fw-bold mb-2" style="color:#E53935;">Complaint Received!</h4>
        <p class="text-muted mb-3">Your complaint has been received by the Barangay office and is now under review.</p>

        <div class="p-3 rounded-3 mb-4 d-inline-block" style="background:#FEE2E2;min-width:320px;">
          <div class="row g-2 text-start">
            ...
            <div class="col-6 text-muted small fw-semibold">Category</div>
            <div class="col-6 small"><?= e($_POST['category'] ?? '') ?></div>
        ...
        <div class="alert alert-warning d-inline-block mb-4">
          ...
          <strong>Save your Record ID!</strong> You will be notified once the barangay reviews your complaint.
        </div>

        <div class="d-flex gap-2 justify-content-center flex-wrap">
          <a href="/BarangayProject/resident/my_submissions.php" class="btn btn-danger">
            <i class="bi bi-folder2-open me-1"></i> View My Submissions
          </a>
          <a href="/BarangayProject/resident/file_complaint.php" class="btn btn-outline-secondary">
            <i class="bi bi-plus me-1"></i> File Another
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-7">
        <div class="card">
          <div class="card-header" style="color:#E53935;">
            <i class="bi bi-exclamation-triangle me-2"></i>Complaint Form
          </div>
            ...
            <form method="post">
              ...
              <div class="mb-4">
                ...
                <textarea name="details" class="form-control" rows="5"
                          placeholder="Describe the complaint in detail — include location, time, and persons involved if applicable…"
                          required><?= e($_POST['details'] ?? '') ?></textarea>
              </div>
